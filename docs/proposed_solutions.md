...
1. ## Timestamp extraction from the on-screen clock overlay
...
3. ## Food and order delivery time tracking
...
4. ## Staff efficiency and server-to-table assignment
...
5. ## Sitting versus standing classification using pose estimation
...
6. ## Spill, hazard, or safety incident detection
...
7. ## Repeat customer recognition via face matching
...
8. ## POS-integrated wait time analysis
...
9. ## Natural language scene summary and question answering
